...
Glucose and glutamin are being used, but never at rate, that would cause the feed to supply too little for the cells to grow.
...
It can be seen that glucose and glutamin levels drop more by the end of the process if the inoculation value is higher, while the @PID control uses more oxygen.
