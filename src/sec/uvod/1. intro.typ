...
It is an expensive undertaking in both time and resources needed to produce the desired end products.
They require expensive bioreactors, cell lines and substrates to run.
Much research is invested into growing, studying and evaluating the optimum conditions for these cell lines, as well as research of optimal bioreactor operating conditions and substrate concentrations.
